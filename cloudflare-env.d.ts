/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 6f197a4a7f7da3e2c7c67f48ef2e8623)
// Runtime types generated with workerd@1.20260911.1 2026-09-12 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_CloudflareEnv {
	ASSETS: Fetcher;
	NEXT_PUBLIC_APP_URL: "https://lastro.feraimentor.workers.dev";
	NEXT_PUBLIC_SUPABASE_URL: "https://heideeuesoyiryooadcb.supabase.co";
	NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY: "sb_publishable_zuR1PhGsWHWcwb350TsTZA_OJABCKTl";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APP_URL" | "NEXT_PUBLIC_SUPABASE_URL" | "NEXT_PUBLIC_SUPABASE_PUBLISHABLE_KEY">> {}
}
